...
void modelo3D::RotarZ(float dtheta){
...
glEnd();
         ...
         Drawarrow3D(O,O+.1*R*vector3d(1,0,0),{1,0,0.2},0.05);
         Drawarrow3D(O,O+.1*R*vector3d(0,1,0),{.1,1,0.2},0.05);
         Drawarrow3D(O,O+.1*R*vector3d(0,0,1),{0.1,0.2,1},0.05);
